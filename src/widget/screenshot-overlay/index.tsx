...
export default () => {
    ...
    const [savedClientGeometry, setSavedClientGeometry] = createState<
        string | null
    >(null);
    const [savedMonitorGeometry, setSavedMonitorGeometry] = createState<
        string | null
    >(null);
        ...
        <Astal.Window
            ...
            onNotifyVisible={self => {
                if (self.visible) {
                    ...
                    if (client) {
                        setSavedClientGeometry(
                            `${client.x},${client.y} ${client.width}x${client.height}`
                        );
                    }
                    const mon = hyprland.focused_monitor;
                    if (mon) {
                        setSavedMonitorGeometry(
                            `${mon.x},${mon.y} ${mon.width}x${mon.height}`
                        );
                    }
                }
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <Adw.ButtonContent
                            iconName={createBinding(ss, 'selected-mode').as(
                                m =>
                                    m === 'screenshot'
