...
export const entries: ComponentEntry[] = [
    // ── Common / Buttons ───────────────────────────────────────────────────
    {
        ...
        editableProps: {
            iconName: {
                type: 'icon',
                label: 'Icon',
                default: IconNames.systemShutdown,
            },
...

    {
        ...
        editableProps: {
            icon: {
                type: 'icon',
                label: 'Icon',
                default: IconNames.networkWireless,
            },
...

    {
        ...
        editableProps: {
            icon: {
                type: 'icon',
                label: 'Icon',
                default: IconNames.avatarDefault,
            },
    ...
    // ── Visual / Graphical ─────────────────────────────────────────────────
    {
        name: 'SunArc',
        category: 'Visual',
        description: 'Custom drawing of sun arc with sunrise/sunset/moon phase',
        render: (p: Record<string, unknown>) =>
            SunArc({
        ...
        presets: [
            ...
            {
                name: 'Night',
                description: 'Past sunset, moon visible',
                props: {
                    sunrise: 6 * 3600,
                    sunset: 18 * 3600,
                    now: 21 * 3600,
    ...
    // ── Common / Controls ──
    {
        name: 'PowerMenu',
        category: 'Controls',
        description: 'Power action menu: lock, suspend, reboot, shutdown',
        render: () => PowerMenu(),
        defaultProps: {},
    },

    {
        ...
        editableProps: {
            icon: {
                type: 'icon',
                label: 'Icon',
                default: IconNames.audioVolumeHigh,
            },
            value: {
                type: 'number',
                label: 'Value',
    ...
    // ── Notifications ────────────────────────────────────────────────────
    {
        ...
        editableProps: {
            appIcon: {
                type: 'icon',
                label: 'App icon',
                default: IconNames.applicationsMultimedia,
            },
            ...
            body: {
                type: 'string',
                label: 'Body',
                default: 'Bohemian Rhapsody — Queen',
            },
            urgency: {
                type: 'select',
                label: 'Urgency',
    ...
    // ── Weather ───────────────────────────────────────────────────────────
    {
        name: 'WeatherIcon',
        category: 'Weather',
        description: 'Compact weather icon + temperature label',
        render: (p: Record<string, unknown>) =>
            MockWeatherIcon({
                iconName: p.iconName as string,
        ...
        editableProps: {
            iconName: {
                type: 'icon',
                label: 'Icon',
                default: IconNames.weatherOvercast,
            },
...

    {
        ...
        presets: [
            {
                name: 'Default (22°C)',
                description: 'Full weather display',
                props: {
                    temperature: 22,
                    showForecast: true,
                    showSunArc: true,
            ...
            {
                name: 'Night (15°C)',
                description: 'Compact night view',
                props: {
                    temperature: 15,
                    showForecast: false,
                    showSunArc: false,
