...
function mockSettings(overrides: Record<string, unknown> = {}) {
  ...
  return {
    autoLockEnabled: { get: defaults.autoLockEnabled, subscribe: () => () => {} },
    idleTimeout: { get: defaults.idleTimeout, subscribe: () => () => {} },
    screenDimEnabled: { get: defaults.screenDimEnabled, subscribe: () => () => {} },
    screenDimTimeout: { get: defaults.screenDimTimeout, subscribe: () => () => {} },
    dpmsEnabled: { get: defaults.dpmsEnabled, subscribe: () => () => {} },
    dpmsTimeout: { get: defaults.dpmsTimeout, subscribe: () => () => {} },
    suspendEnabled: { get: defaults.suspendEnabled, subscribe: () => () => {} },
    suspendTimeout: { get: defaults.suspendTimeout, subscribe: () => () => {} },
    setAutoLockEnabled: () => {},
    setIdleTimeout: () => {},
    setScreenDimEnabled: () => {},
    setScreenDimTimeout: () => {},
